...
`Plugin.Maui.FormsMigration` provides the ability to do this amazing thing in your .NET MAUI application.
...
`Plugin.Maui.FormsMigration` provides the `Feature` class that has a single property `Property` that you can get or set.
